                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="border subTotal text-center m-2">
                            <h6 class="fontSize12 fontRaleway  py-3"> 
                                <?php 
                                    if(isset($subTotal)){
                                      echo  '<i class="fas fa-check"></i>&nbsp;&nbsp;<span class="text-success">Your order is eligble for free delivery</span>';
                                    }else{
                                        echo  '<i class="fas fa-times"></i>&nbsp;&nbsp;<span class="text-danger">Your order is not eligble for free delivery</span>';
